                        ...
                        onPressed: () {
                          final StudentDataEntryModel studentDataEntryModel =
                              StudentDataEntryModel(
                                  ...
                                  scholarshipHolder: scholarshipHolderController
                                          .text
                                          .toLowerCase() ==
                                      "true",
                                  ...
                                  avgEnrolled:
                                      double.parse(avgEnrolledController.text),
                                  avgApproved:
                                      double.parse(avgApprovedController.text),
                                  avgGrade:
                                      double.parse(avgGradeController.text));

                      ;

                          // StudentDataEntryRepo.addStudentData(
                          //     studentDataEntryModel: studentDataEntryModel);
                        },
                        label: 'Upload',
                      ),
